...
class tx_feeditadvanced_editpanel {
	...
	protected function addIncludes() {
		...
		$GLOBALS['TSFE']->additionalHeaderData['extjs.css'] = '<script type="text/javascript">
			/*<![CDATA[*/
				Ext.BLANK_IMAGE_URL = "typo3/gfx/clear.gif";
			/*]]>*/
			</script>
			<link rel="stylesheet" type="text/css" href="typo3/contrib/extjs/resources/css/ext-all.css" />
			<link rel="stylesheet" type="text/css" href="typo3/contrib/extjs/resources/css/xtheme-gray.css" />
';
